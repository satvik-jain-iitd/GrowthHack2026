# Build/Buy/Reuse Assessment Template
...
## Business Vision & Objective

Describe the context in which the BvB decision is being made. Include relevant background information, the problem that needs to be solved, and any constraints or requirements that are pertinent to the decision.
...
General Build-vs-Buy Scorecard:
...
Foundational Technology Public Cloud Adoption Build-vs-Buy Scorecard:

<iframe width="100%" height="600" frameborder="0" scrolling="no" src="https://spaces.aexp.com/teams/GR Architecture/_layouts/15/Doc.aspx?sourcedoc={1b2e19cf-fc50-4319-8d31-70c734ef4551}&action=embedview&wdAllowInteractivity=False&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True"></iframe>
